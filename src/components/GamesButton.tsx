...
/*
* Homepage button to choose your game.
* @param label - a string which is written to the button
*/
export default function GamesButton({ label }: { label: string }) {
  ...
  return (
    <>
      <Pressable 
        className='items-center justify-center border w-3/5 h-1/6 m-2 rounded-md px-4 py-2'
